const config = {
  ...
  dxscList: {
    url: "sczb-URL-prefix/index_sczb/sc_info/page/cm/dxsc",
    method: "post",
    bodyType:"application/json"
  },
  fwbscList: {
  ...
  queryMaterialTable: {
    url: "/sczb-URL-prefix/index_sczb/sc_info/page/group",
    method: "post",
    bodyType:"application/json"
  },
  // 多篇预览
...
// 要素管理新增
  ...
  cbjlDataTable: {
    url: "/sczb-URL-prefix/index_sczb/tscp_info/page/cbjl",
    method: "get"
  },
  produceAbstract: {
  ...
  //获取部门树形结构数据
  getDeptTree: {
    url: "/sczb-URL-prefix/dept/deptTree",
    method: "get"
  },
  //获取部门用户列表
  getDeptUsers: {
    url: "/sczb-URL-prefix/user/users",
    method: "get"
  },
  //获取角色列表
  getRolesList: {
    url: "/sczb-URL-prefix/role/roles",
    method: "get"
  },
  //更新用户角色信息
  updateUserRoles: {
...
// 整编任务提交审核
  ...
  getzhengbianitemlist:{
    url: "/sczb-URL-prefix/index_sczb/tscp_info/",
    method: "get"
  },
...
//  素材翻译-翻译工具-文本翻译
  ...
  //繁体简体互转
  switchContent: {
    url: "sczb-URL-prefix/data/getTrToSimText",
    method: "post",
    bodyType:"application/json"
  },
  //控制台素材翻译累计未完成任务统计
