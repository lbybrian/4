(function(config) {
  ...
  function ha() {
    ...
    return 0 <= a.indexOf("nvidia") || 0 <= a.indexOf("quadro") || 0 <= a.indexOf("geforce") || 0 <= a.indexOf(
      "nvs") ? (b = ["nVidia"], 0 <= a.indexOf("geforce") && b.push("geForce"), 0 <= a.indexOf("quadro") && b.push(
          "Quadro"), 0 <= a.indexOf("nvs") && b.push("NVS"), a.match(/\bion\b/) && b.push("ION"), a.match(/gtx\b/) ? b
        .push("GTX") : a.match(/gts\b/) ? b.push("GTS") : a.match(/gt\b/) ? b.push("GT") : a.match(/gs\b/) ? b.push(
          "GS") : a.match(/ge\b/) ?
        b.push("GE") : a.match(/fx\b/) && b.push("FX"), (c = a.match(ga)) && b.push(c[1].toUpperCase().replace("GS",
          "")), 0 <= a.indexOf("titan") ? b.push("TITAN") : 0 <= a.indexOf("ti") && b.push("Ti"), b = b.join(" ")) :
      0 <= a.indexOf("amd") || 0 <= a.indexOf("ati") || 0 <= a.indexOf("radeon") || 0 <= a.indexOf("firegl") || 0 <= a
      .indexOf("firepro") ? (b = ["AMD"], 0 <= a.indexOf("mobil") && b.push("Mobility"), c = a.indexOf("radeon"), 0 <=
        c && b.push("Radeon"), 0 <= a.indexOf("firepro") ? b.push("FirePro") : 0 <= a.indexOf("firegl") && b.push(
          "FireGL"), 0 <= a.indexOf("hd") &&
        b.push("HD"), 0 <= c && (a = a.substring(c)), (c = a.match(ga)) && b.push(c[1].toUpperCase().replace("HD",
  ...
  var ja =
    ...
    la = "devicePixelRatio" in e && 1 < e.devicePixelRatio || ka && "matchMedia" in e && e.matchMedia(
      "(min-resolution:144dpi)") && e.matchMedia("(min-resolution:144dpi)").matches,
    oa = T("windows nt"),
    ...
    Ab = function() {
      ...
      for (var a = ["webgl", "experimental-webgl", "moz-webgl"], b = null, c = 0; c < a.length; c += 1) {
        ...
        if (b) {
          ...
          if (f > yb) break;
          if (23 > b.getShaderPrecisionFormat(35632, 36338).precision || 23 > b.getShaderPrecisionFormat(35633, 36338)
            .precision) break;
  ...
  config.Fd += "c";
  config.j.ne && (config.Fd += "v", Ub += ",vectorlayer,overlay", config.j.Zd ? (config.Fd += "w", Ub += ",wgl") : (
  ...
  var Zb = window.AMap.TC = {},
    mc = config[2].split(",")[0],
    nc = mc + "/theme/v" + config[4] + "/style1536672475627.css?v=2",
  ...
  function rc() {
    for (var a = mc + "/maps/main?v=" + config[4] + "&key=" + config[0] + "&m=" + config.AN.join(",") +
        "&vrs=1536672475627", b = document.getElementsByTagName("script"), c, d = 0; d < b.length; d += 1)
      if (0 === b[d].src.indexOf(mc.split(":")[1] + "/maps?")) {
        c = b[d];
        break
      } config[5] || c && c.async ? qc(a) : (document.write('<script id="amap_main_js" src=\'' + a +
  ...
  try {
    if (window.localStorage) {
      ...
      if (uc)
        for (Xb in window.localStorage) window.localStorage.hasOwnProperty(Xb) && 0 === Xb.indexOf("_AMap_") && window
          .localStorage.removeItem(Xb)
    }
  } catch (vc) {}
  ...
  (typeof _cssload_ == "function") && _cssload_("logo", ".amap-logo{display:block!important;pointer-events:none;}",
    true)
})(["", [113.758151, 36.742731, 115.853918, 37.812803, 114.508851, 37.0682], "http://webapi.amap.com", 1, "1.3", null,
  "130500", "", true, false, false, true, "1614103611-20201123-1", false, "D", "3_21_03_03_01"
])
