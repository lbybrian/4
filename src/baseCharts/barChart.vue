    ...
    updateOption() {
      ...
      for (var i = 0; i < data.data.length; i++) {
        ...
        for (var j = 0; j < this.option.series.length; j++) {
          ...
          this.option.series[j].barWidth=data.barWidth||'';
          this.option.series[j].label=data.label||{show:false};
        }
      }
      // console.log(this.option.series,8888)
    },
