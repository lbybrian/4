<template>
	<div class="containerArea">
		<el-table v-if="isShow" :data="dataInfo.data" ref="dataTableItem" :height="dataInfo.height" :max-height="dataInfo.maxHeight" :stripe="dataInfo.stripe || false" :border="dataInfo.border || false" :empty-text="dataInfo.emptyText || '暂无数据'" :fit="dataInfo.fit === undefined ? true : dataInfo.fit" :highlight-current-row="dataInfo.heightCurrentRow" :show-header="dataInfo.showHeader === undefined ? true : dataInfo.showHeader" @row-click="rowClick" @selection-change="handleSelectionChange" @cell-click="dealCellClick"  @sort-change="dealSortChange" @current-change="dealHighlightChange" style="width: 100%" v-loading="dataInfo.loading" element-loading-text="拼命加载中" :header-cell-style="{background:'#fbfbfb'}">
